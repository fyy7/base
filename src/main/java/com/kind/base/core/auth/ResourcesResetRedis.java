...
public class ResourcesResetRedis extends DbHelper {
	...
	public List<Map<String, Object>> getRedis(HashMap<String, String> hmLogSql, String appid) {
		...
		if (cache != null) {
			...
			String querySql = "SELECT '1' TYPE,EXTITEM1,EXTITEM3,ISGROUP,RLEVEL,RID,PARENTID,TITLE,RLOGO,ALLORDIDX,0 BVALUE,APP_ID FROM SYS_RESOURCES A WHERE VISIBLE=1 AND CHANNEL_RTYPE='00001' AND (APP_ID = 'APP0001' OR APP_ID = 'APP0002' OR APP_ID=?)  order by ALLORDIDX";
