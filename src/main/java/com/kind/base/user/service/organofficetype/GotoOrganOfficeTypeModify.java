...
@Service
@Action(requireLogin = true, action = "#organ_office_type_modify", description = "机构职务类型维护", powerCode = "", requireTransaction = false)
public class GotoOrganOfficeTypeModify extends BaseActionService {
	...
	public String pageAddress(DataContext dc) {
		return "user/sysdmb/organdeptoffice/organ_dmb_modify";
	}
