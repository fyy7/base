...
@Service
@Action(requireLogin = true, action = "#organ_office_type_query", description = "机构职务类型列表查询", powerCode = "", requireTransaction = false)
public class QueryOrganOfficeTypeListService extends BaseActionService {
