...
@Service
@Action(requireLogin = true, action = "#organ_office_type_save", description = "机构职务类型保存", powerCode = "", requireTransaction = true)
public class SaveOrganOfficeTypeService extends BaseActionService {
